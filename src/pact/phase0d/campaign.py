...
ALLOWED_STATUSES = frozenset({
    ...
    "SKIPPED_EXISTING", "SKIPPED_NO_QUALIFIED_CANDIDATE", "REUSED_VERIFIED",
})
COMPLETED_STATUSES = frozenset({
    "QUALIFIED", "INVALID", "TIMEOUT", "FAILED", "SKIPPED_EXISTING",
    "SKIPPED_NO_QUALIFIED_CANDIDATE", "REUSED_VERIFIED",
})
